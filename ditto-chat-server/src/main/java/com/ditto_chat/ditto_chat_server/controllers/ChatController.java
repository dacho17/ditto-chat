...
public class ChatController extends GeneralController {
    ...
    public ResponseEntity<ResponseBody<ChatThreadDto>> newChatThread(
		...
		return ResponseEntity
			...
			.body(new ResponseBody<ChatThreadDto>(null, newChatThreadDto));
    }
    ...
    public ResponseEntity<ResponseBody<ChatThreadDto>> getChatThread(
		...
		return ResponseEntity
			...
			.body(new ResponseBody<ChatThreadDto>(null, retrievedChatThreadDto));
    }
    ...
    public ResponseEntity<?> getChatThreadMessages(
        ...
        if (EntityPaginationHelper.doesEntityPageExist(chatThreaadMessagesDtoPage.getPageList(), pageNumber, isInitialRetrieval) == false) {
		...
		return ResponseEntity
			.status(HttpStatus.OK)
			.body(new ResponseBody<ResponsePagedListDto<ChatThreadMessageDto>>(null, chatThreaadMessagesDtoPage));
    }
    ...
    public ResponseEntity<ResponseBody<ChatThreadMessageDto>> updateLastSeenMessage(
		...
		return ResponseEntity
			.status(HttpStatus.CREATED)
			.body(new ResponseBody<ChatThreadMessageDto>(null, lastSeenChatThreadMessageDto));
    }
    ...
    public ResponseEntity<ResponseBody<ChatThreadMessageDto>> sendChatThreadMessage(
		...
		return ResponseEntity
			.status(HttpStatus.CREATED)
			.body(new ResponseBody<ChatThreadMessageDto>(null, sentChatThreadMessageDto));
    }
    ...
    public ResponseEntity<ResponseBody<ChatThreadHistoryClearedDto>> clearChatThreadHistory(
		...
		return ResponseEntity
			.status(HttpStatus.CREATED)
			.body(new ResponseBody<ChatThreadHistoryClearedDto>(this.CHAT_THREAD_HISTORY_CLEARED_AT_SUCCESS_MESSAGE, newChatThreadHistoryClearedDto));
    }
}
